...
struct TakeSelfieView: View, RouterPage {
                    ...
                    AVCamera()
                        ...
                        .onChange(of: self.cameraModel.photo){ photo in
                            if (photo != nil){
                                ...
                                attachment.fileName = "selfie.jpg"
                                attachment.documentType = .init(id: .selfie, key: "selfie", label: "Selfie", image: "", description: "")
                                attachment.key = randomString(length: 6)
                                self.Store.onboarding.selfie = attachment
