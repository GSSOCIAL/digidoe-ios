...
struct ScanProofOfAddressView: View, RouterPage {
            ...
            GeometryReader{ geometry in
                ZStack{
                    AVCamera()
                        ...
                        .overlay(
                            Text(LocalizedStringKey("Take photo of proof of address"))
                        ...
                        .onChange(of: self.cameraModel.photo){ photo in
                            if (photo != nil){
                                ...
                                let type = ProofOfAddressView.documentTypes.first(where: {$0.key == self.Store.onboarding.proofOfAddressDocumentType})
...
struct ScanProofOfAddressView_Previews: PreviewProvider {
