...
struct TermsConditionsView: View, RouterPage{
    ...
    func getTermsConditions() async throws{
        if (self.loading){
            return;
        }
        self.loading = true
        let response = try await services.terms.getTermsConditions()
        #if DEBUG
            ...
            GeometryReader{ geometry in
                ScrollView{
                    ...
                    .onAppear{
                        Task{
                            do{
                                try await self.getTermsConditions()
                            }catch(let error){
                                self.loading = false
